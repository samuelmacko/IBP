...
% Basic packages are at the bottom of _template file fitthesis.cls
...
% disables function of the _template which replaces quotation marks
...
% can not be placed in the _template file.
\ifWis
